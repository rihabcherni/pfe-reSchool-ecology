            ...
            <Visibility once={false} onBottomPassed={this.showFixedMenu} onBottomPassedReverse={this.hideFixedMenu}>  
                <Menu className="ui top fixed menu horizontale" inverted={!fixed} style={{ padding: '1em 1em 1em 3%' }} pointing={!fixed} secondary={!fixed} size='large' borderless>                        
                    ...
                    <Container className="menu-header"> 
                        ...
                        <Menu.Item as='a' href='#partenaires' name='partenaires'  active={activeItem === 'partenaires'} onClick={this.handleItemClick}>Partenaires</Menu.Item>
                        <Menu.Item as='a' href='#equipe' name='equipe'  active={activeItem === 'equipe'} onClick={this.handleItemClick}>Equipe</Menu.Item>
