...
export default function ReparateurPoubelleTable() {
  ...
  const url = `${process.env.REACT_APP_API_KEY}/api/reparateur-poubelle`
  const columnDefs = [
    ...
    <img  style={{height:"47px", width:"47px", borderRadius:"50%"}} 
          src={`${process.env.REACT_APP_API_KEY}/storage/images/reparateur_poubelle/${params.data.photo}`}alt="mecanicien" />},
  ...
  const columnDefsTrash = [
    ...
    { headerName: "photo", field: "photo" , maxWidth: 140 , minWidth:100, cellRenderer: (params) =>
    <img  style={{height:"47px", width:"47px", borderRadius:"50%"}} 
          src={`${process.env.REACT_APP_API_KEY}/storage/trashImages/reparateur_poubelle/${params.data.photo}`}alt="mecanicien" />},
    { headerName: "Nom", field: "nom" , maxWidth: 180 , minWidth:160},
    { headerName: "Prénom", field: "prenom" , maxWidth: 180 , minWidth:160},
    { headerName: "CIN", field: "CIN" , maxWidth: 180 , minWidth:160},
    { headerName: "Numéro télèphone", field: "numero_telephone" , maxWidth: 180 , minWidth:160 },
    ...
    return (
        <div style={{width:"100%"}}>
              <Api tableNameSing='Réparateur des poubelles' tableNamePlu='Réparateurs des poubelles' 
